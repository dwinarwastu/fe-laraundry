      ...
      <div class="row">
              ...
              <h2>Input Transaksi</h2>
                <div class="table-responsive">
                  ...
                  <div class="form-group">
                    ...
                    <input type="a" class="form-control" placeholder="Lama Pengerjaan" v-model="lama_pengerjaan" required>
                  </div>
                  </div>
              </div>
          </div>
        ...
        <div class="col-lg-6 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <div class="table-responsive">
                  <b-button @click="addItem"  variant="warning"><i class="mdi mdi-plus btn-icon-prepend"></i> Tambah Item</b-button>
                  <br><br>
        ...
        if(response.data.success == false){
          ...
          .then(response2 => {
            if(response2.data.success == true){
                ...
                alert("Anda tidak dapat menambahkan transaksi!!!")
            }
